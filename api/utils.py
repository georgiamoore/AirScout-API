...
def get_feature_collection_between_timestamps(start_timestamp, end_timestamp, columns, pollutants, reading_table, sensor_table, sensor_pkey_column, sensor_location_column):
    ...
    cursor.execute("""
        ...
        """ % (sensor_location_column, ", ".join([columns_str, pollutants_str]), reading_table, sensor_table, sensor_pkey_column, start_timestamp, end_timestamp))
...
def get_chart_format(days, cols, pollutants):
    ...
    feature_collection = get_feature_collection_between_timestamps(start_timestamp, end_timestamp, cols, pollutants, 'defra', 'defra_station', 'station_code', 'station_location')
